      ...
      <div className="max-w-sm mx-auto py-6 flex flex-col items-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="w-full grid grid-cols-2 gap-2">
          <button onClick={handleWhatsApp}
            className="flex flex-col items-center gap-1.5 py-3 bg-[#D1FAE5] rounded-xl text-xs font-semibold text-[#059669] hover:bg-[#A7F3D0] transition-colors">
          ...
          <button onClick={handleEmail}
            className="flex flex-col items-center gap-1.5 py-3 bg-blue-50 rounded-xl text-xs font-semibold text-blue-700 hover:bg-blue-100 transition-colors">
            <Send size={18} />
            Email
          </button>
          ...
          <button onClick={handleThermalPrint}
            className="flex flex-col items-center gap-1.5 py-3 bg-orange-50 rounded-xl text-xs font-semibold text-orange-700 hover:bg-orange-100 transition-colors">
            <Printer size={18} />
            Thermal / Receipt
          </button>
        </div>
